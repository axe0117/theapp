...
class StarRailFinder {
     ...
     */
    skin(skinId, language = this.language) {
        if (!skinId)
            throw new errors_1.AssetFinderError("You must provide a skin id");
        if (isNaN(+skinId))
            throw new errors_1.AssetFinderError("The skin id must be a valid integer or string");
        return new structs_1.SRSkin(skinId, language);
    }
    /**
