...
import { SRCharacterAssets, SREidolon, SRHash, SRLightcone, SRProfilePicture, SRRelic, SRSkillTree, SRSkin } from "../../structs";
/**
...
export declare class StarRailFinder {
     ...
     */
    skin(skinId: string | number, language?: string): SRSkin;
    /**
