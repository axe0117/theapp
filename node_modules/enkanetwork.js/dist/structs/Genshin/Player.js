...
class Namecard {
    ...
    constructor(namecardId, language) {
        const namecard = utils_1.genshinFinder[`${language}`].namecard(namecardId || "0");
        this.id = namecardId || "";
...
class Showcase {
     ...
     */
    constructor(data, language) {
        const character = utils_1.genshinFinder[`${language}`].character(data.avatarId || "0");
...
class ProfilePicture {
    ...
    constructor(data, language) {
        const profilePicture = data.avatarId
            ? utils_1.genshinFinder[`${language}`].character(data.avatarId)
            : utils_1.genshinFinder[`${language}`].profilePicture(data.id || "0");
        this.characterId = data.avatarId || "";
        this.id = data.id || "";
