...
class Characters {
    ...
    constructor(data, language) {
        ...
        const character = utils_1.genshinFinder[`${language}`].character(charDepot || data.avatarId);
...
class Constellations {
    ...
    constructor(constellationId, language) {
        const constellation = utils_1.genshinFinder[`${language}`].constellation(constellationId);
