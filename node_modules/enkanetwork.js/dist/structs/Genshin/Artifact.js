...
class Artifact {
    ...
    constructor(data, language) {
        ...
        this.name = utils_1.genshinFinder[`${language}`].hash(this.nameTextMapHash).value;
        this.setName = utils_1.genshinFinder[`${language}`].hash(this.setNameTextMapHash).value;
    }
    sumRollQuality() {
        const rollsQuality = [];
