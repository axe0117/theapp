...
class HoyoBuilds {
    ...
    constructor(data, language) {
        ...
        this.characterName =
            data.hoyo_type == 0
                ? utils_1.genshinFinder[`${language}`].character(this.characterId).name
                : utils_1.starrailFinder[`${language}`].character(this.characterId).name;
        this.characterInfo =
            data.hoyo_type == 0
                ? new Genshin_1.Characters(data.avatar_data, language)
                : new StarRail_1.SRCharacters(data.avatar_data, language);
