...
exports.NamecardImages = exports.NamecardAssets = void 0;
const utils_1 = require("../../../utils");
const namecards = utils_1.namecards;
/**
 * A class that structures the namecard assets and name.
 */
class NamecardAssets {
    /**
     ...
     */
    constructor(namecardId, language) {
        const namecard = namecards[namecardId];
        this.name = utils_1.genshinFinder[language].hash(namecard?.nameTextMapHash).value;
        this.assets = namecard
            ? new NamecardImages(namecard)
            : {};
    }
}
exports.NamecardAssets = NamecardAssets;
/**
 * A class that structures the namecard images.
 */
class NamecardImages {
    /**
     * The namecard's icon.
     */
    icon;
...
exports.NamecardImages = NamecardImages;
