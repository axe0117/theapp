...
exports.ProfilePictureImages = exports.ProfilePictureAssets = void 0;
const utils_1 = require("../../../utils");
const profilepictures = utils_1.profilepictures;
/**
 * A class that structures the profile pictures assets and names
 */
class ProfilePictureAssets {
    /**
     ...
     */
    constructor(profilePictureId, language) {
        const profilepicture = profilepictures[profilePictureId];
        this.name = utils_1.genshinFinder[language].hash(profilepicture?.nameTextMapHash).value;
        this.assets = profilepicture
            ? new ProfilePictureImages(profilepicture)
            : {};
    }
}
exports.ProfilePictureAssets = ProfilePictureAssets;
class ProfilePictureImages {
    /**
...
exports.ProfilePictureImages = ProfilePictureImages;
