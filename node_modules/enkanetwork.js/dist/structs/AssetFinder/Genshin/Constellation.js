...
exports.ConstellationImages = exports.ConstellationAssets = void 0;
const utils_1 = require("../../../utils");
const talents = utils_1.talents;
/**
 * A class that structures the constellation assets and name.
 */
class ConstellationAssets {
    /**
     ...
     */
    constructor(constellationId, language) {
        const constellation = talents[constellationId];
        this.name = utils_1.genshinFinder[language].hash(constellation?.nameTextMapHash).value;
        this.assets = constellation
            ? new ConstellationImages(constellation)
            : {};
    }
}
exports.ConstellationAssets = ConstellationAssets;
/**
 * A class that structures the constellation images.
 */
class ConstellationImages {
    /**
...
exports.ConstellationImages = ConstellationImages;
