...
exports.ReliquaryFinder = void 0;
const errors_1 = require("../../errors");
class ReliquaryFinder {
    localization;
    ...
    getName(nameTextMapHash, language) {
        ...
        if (!nameLocalizations)
            throw new errors_1.NoLocalizationAssetsFound(`There is no localization for reliquary with nameTextMapHash = ${nameTextMapHash}! (check the actuality of assets)`);
...
exports.ReliquaryFinder = ReliquaryFinder;
